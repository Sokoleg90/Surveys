<template>
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-3">
            <label for="question_type" class="block text-sm font-medium text-gray-700">Выберите тип вопроса</label>
            <select
                id="question_type"
                name="question_type"
                v-model="model.type"
...
const emits = defineEmits(["change", "addQuestions", "deleteQuestions"]);
...
//Check if the question should have option
